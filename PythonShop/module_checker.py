class IsModulePreset:
    def __init__(self):
        self.modules_list = ['__future__', '__hello__', '__main__', '__phello__', '_abc', '_aix_support', '_android_support', '_apple_support', '_ast', '_asyncio', '_bisect',
        ...
        'pyexpat', 'pyparse', 'pyshell', 'query', 'queue', 'quopri', 'random', 're', 'redirector', 'replace', 'reprlib', 'rlcompleter', 'rpc',
    ...
    def check_in(self, module):
        isin = module in self.modules_list
